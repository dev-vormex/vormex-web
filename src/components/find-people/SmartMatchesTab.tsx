...
export function SmartMatchesTab() {
  ...
  const matches = useMemo(() => {
    const byUserId = new Map<string, SmartMatch>();
    data?.pages.forEach((page) => {
      page.matches.forEach((match) => byUserId.set(match.user.id, match));
    });
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  <VerificationBadge
                    profileBadgeStyle={match.user.profileBadgeStyle}
          ...
          {hasNextPage && (
            <div ref={loadMoreRef} className="flex justify-center py-6">
              <button
                ...
                className="rounded-full border border-gray-300 px-5 py-2 text-sm font-semibold text-gray-600 disabled:opacity-60 dark:border-neutral-700 dark:text-neutral-300"
              >
