          ...
          <div className="flex flex-wrap gap-2">
            {user.interests.map((interest, index) => (
              <RevealItem key={interest} index={index}>
                <span className="group inline-flex items-center gap-1.5 pl-3.5 pr-3 py-1.5 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-200 text-sm font-medium hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-500/10 dark:hover:text-blue-400 transition-colors select-none">
                  {interest}
...
function StatCard({ icon, label, value, index }: StatCardProps) {
  return (
    <RevealItem index={index}>
      <div className="group p-4 rounded-xl bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800 hover:border-blue-200 dark:hover:border-blue-500/30 hover:bg-blue-50/50 dark:hover:bg-blue-500/5 transition-colors flex flex-col items-center justify-center text-center">
        <div className="mb-2 text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
          {icon}
        </div>
